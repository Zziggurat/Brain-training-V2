...
(function (globalScope, factory) {
  ...
  /*
   * Progresión de dificultad: todos los generadores aceptan un `tier`
   * (1 = principiante, 2 = intermedio, 3 = avanzado) que escala sus
   * rangos. byTier devuelve el valor correspondiente al tramo.
   */
  ...
  function genAncla15_25(rng, tier = 2) {
  ...
  function genComprobacion9(rng, tier = 2) {
  ...
  function genCuadrados(rng, tier = 2) {
    const n = randInt(rng, 31, byTier(tier, 40, 46, 50));
